            ...
            <div className="flex gap-4">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="px-6 py-2.5 bg-orange text-white font-medium rounded-md hover:bg-orange/90 focus:outline-none focus:ring-2 focus:ring-orange focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {adding ? (
                    <>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      {isCurrentUser && (
                        <span className="px-2 py-1 text-xs font-medium bg-orange/10 text-orange rounded-md">
                          You
                        </span>
                      )}
                    </div>
                    <button
                      ...
                      className="px-4 py-2 text-red-600 hover:bg-red-50 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
